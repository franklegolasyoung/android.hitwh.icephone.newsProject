...
public class MoneyNewsAdapter extends RecyclerView.Adapter<MoneyNewsAdapter.ViewHolder> {

    private List<News.DataBean.MoneyBean> aNewsList;
    ...
    public MoneyNewsAdapter(List<News.DataBean.MoneyBean> NewsList) {
        aNewsList = NewsList;
    }
    @Override
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        News.DataBean.MoneyBean news = aNewsList.get(position);
        /*try {
